...
const packageName = "@hraness/codex-app-sdk";
const importSpecifiers = ["@hraness/codex-app-sdk","@hraness/codex-app-sdk/react","@hraness/codex-app-sdk/testing"];
const binNames = [];
...
try {
  ...
  await writeFile(join(consumer, "index.ts"), "import * as surface0 from \"@hraness/codex-app-sdk\";\nimport * as surface1 from \"@hraness/codex-app-sdk/react\";\nimport * as surface2 from \"@hraness/codex-app-sdk/testing\";\nvoid [surface0, surface1, surface2];\n");
